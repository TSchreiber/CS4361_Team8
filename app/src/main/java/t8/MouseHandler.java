...
public class MouseHandler implements EventHandler<MouseEvent> {
    ...
    private final FaceRotationHandler faceRotationHandler;
    private final CubeRotationHandler cubeRotationHandler;
    private boolean enabled = true;

    public MouseHandler(RubiksCube cube) {
        this.cube = cube;
        cubeRotationHandler = new CubeRotationHandler();
        faceRotationHandler = new FaceRotationHandler();
    }
    ...
    private class CubeRotationHandler implements EventHandler<MouseEvent> {
    ...
    private class FaceRotationHandler implements EventHandler<MouseEvent> {
