...
public class Launcher extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        moveCount.setFont(Font.font("Helvetica", FontWeight.BOLD, 70));
        timerLabel.setFont(Font.font("Helvetica", FontWeight.BOLD, 70));
        ...
        VBox moveStuff = new VBox(moves,moveCount);
        moveStuff.setMinWidth(300);
        moveStuff.setAlignment(Pos.TOP_CENTER);
        moveStuff.setBorder(new Border(new BorderStroke(Color.GRAY, BorderStrokeStyle.SOLID, CornerRadii.EMPTY, new BorderWidths(3))));
        moveStuff.setBackground(new Background(new BackgroundFill(Color.WHITE, CornerRadii.EMPTY, Insets.EMPTY)));
        VBox timeStuff = new VBox(timetitle,timerLabel);
        timeStuff.setMinWidth(300);
        timeStuff.setAlignment(Pos.TOP_CENTER);
        timeStuff.setBorder(new Border(new BorderStroke(Color.GRAY, BorderStrokeStyle.SOLID, CornerRadii.EMPTY, new BorderWidths(3))));
        timeStuff.setBackground(new Background(new BackgroundFill(Color.WHITE, CornerRadii.EMPTY, Insets.EMPTY)));

        VBox moveCounter = new VBox(moveStuff,timeStuff, buttonRestart, buttonPause, buttonClose);
        ...
        SubScene scene3d = new SubScene(root3d, 1000, 800, true, SceneAntialiasing.BALANCED);
